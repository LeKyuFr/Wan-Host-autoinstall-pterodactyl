<h1 align="center"><strong>Pterodactyl Auto-Installer</strong></h1>
...
```bash
bash <(curl -s https://raw.githubusercontent.com/guldkage/Pterodactyl-Installer/main/autoinstall.sh) <fqdn> <ssl> <email> <wings>
```
